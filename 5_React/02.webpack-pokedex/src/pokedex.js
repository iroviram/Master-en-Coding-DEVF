...
class Pokedex{
    constructor(pokemons){
        this._pokemons = pokemons; //Mi lista de pokemon de la API
    ...
    //Construya un Card de Bootstrap con la informacion de un pokemon
...
//Traiga los datos de un Pokemon especifico para poder llenar los datos de la tarjeta
    singlePokemonCard(pokemon){ //Objeto Pokemon
    ...
    //Inicializa mi logica del Pokedex
    createPokedex(){
