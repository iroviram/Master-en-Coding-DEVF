...
// #1 Añado información de manejo de la API
  const apiKey = 'd8cd709a934d68e24f4faa786405e133'; // process.env.REACT_APP_WEATHER_API_KEY;
  console.log(apiKey);
          ...
          <section className="data">
            {apiData.main ? (
              <main>
                ...
                <p>Temp. Minima: <strong>{apiData.main.temp_min}</strong></p>
                <p>Temp. Maxima: <strong>{apiData.main.temp_max}</strong></p>
