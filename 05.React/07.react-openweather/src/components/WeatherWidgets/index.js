...
function weatherWidget({weatherData}) {
    ...
    let year = newDate.getFullYear(); // Regresa el Anio Actual
    let dayNumber = newDate.getDay(); // Regresa el Valor Numerico del dia de la semana. Empieza con 0 que es Domingo
